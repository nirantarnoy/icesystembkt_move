...
/**
 * This is the model class for table "query_saleorder_by_customer_loan_sum_new".
 *
 ...
 */
class QuerySaleorderByCustomerLoanSumNew extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'query_saleorder_by_customer_loan_sum_new';
    }
    ...
    {
        return [
            [['rt_id', 'customer_id', 'sale_channel_id', 'company_id', 'branch_id', 'customer_type_id', 'car_ref_id', 'order_id'], 'integer'],
            [['order_date'], 'safe'],
