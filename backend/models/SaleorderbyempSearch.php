...
use common\models\QuerySaleorderByEmp;
 ...
 */
class SaleorderbyempSearch extends QuerySaleorderByEmp
{
    public $globalSearch;
...
//            [['code', 'name', 'note'], 'safe'],
//            [['globalSearch'],'string']
            [['emp_fname','emp_lname'],'safe'],
            [['customer_id', 'rt_id', 'payment_method_id','employee_id'], 'integer'],
            [['order_date'], 'safe'],
            [['product_id'], 'safe']
        ];
    }
    ...
    {
        $query = QuerySaleorderByEmp::find();
