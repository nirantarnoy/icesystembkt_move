...
if ($from_date != null && $to_date != null) {
    ...
    $model_line = \common\models\QueryOrderCustomerProduct2::find()->select(['id', 'order_no','order_date','customer_id','order_channel_id'])
...
<div>
    ...
    <form action="<?= \yii\helpers\Url::to(['pos/printsummaryposnky'], true) ?>" method="post" id="form-search">
