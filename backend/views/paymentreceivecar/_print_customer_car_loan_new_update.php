...
<head>
    ...
    <form action="<?= \yii\helpers\Url::to(['paymentreceivecar/carsummaryupdate'], true) ?>" method="post" id="form-search">
    ...
    <table class="table-header" width="100%">
        <tr>
            <td style="text-align: center; font-size: 20px; font-weight: bold">
                รายงานสรุปยอดหนี้ลูกค้าขายเชื่อ(แยกสายส่ง)
            </td>
        </tr>
    </table>
    <br>
    ...
    <table class="table-title" id="table-data" style="width: 100%">
        <form action="<?= \yii\helpers\Url::to(['paymentreceivecar/saveupdate'], true) ?>" method="post"
              id="form-search">
            <tr>
                ...
                <td style="text-align: center;border: 1px solid gray"><b>เลขที่ใบส่งของ</b></td>
            </tr>
            <?php
                ...
                <?php foreach ($model_customer_loan as $value): ?>
                    ...
                    <?php if ($find_order != null): ?>
                        ...
                        <?php for ($i = 0; $i <= count($find_order) - 1; $i++): ?>
                            ...
                            $curren_customer = $find_order[$i]['customer_name'];
                            if ($xx == 1) {
                                $old_line_customer = $curren_customer;
                            }
...
//
                            ...
                            ?>
                            <?php if ($old_line_customer <> $curren_customer && $line_remain > 0): ?>
                            ...
                            <tr>
                                ...
                                <td style="font-size: 16px;border: 1px solid gray;text-align: center"><?= $find_order[$i]['order_no'] ?>
