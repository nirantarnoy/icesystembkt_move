...
<table class="table-header" width="100%">
    <tr>
        <td style="font-size: 18px;text-align: left">เลขที่ <span><?php echo $model->journal_no; ?></span>
</td>
...
<table class="table-header">
    <tr>
        <td style="font-size: 18px;">พนักงาน ........ <span style="position: absolute;"><?=\backend\models\User::findName(\Yii::$app->user->id)?></span> .........</td>
    </tr>
    <tr>
    </tr>
</table>
...
<?php
    ...
    if(file_exists('../web/uploads/slip_prod/slip_prodrec_index.pdf')){
        unlink('../web/uploads/slip_prod/slip_prodrec_index.pdf');
    }
...
$mpdf->SetJS('this.print();');
    ...
    $mpdf->Output('../web/uploads/slip_prod/slip_prodrec_index.pdf', 'F');
