...
<body>
<form action="<?= \yii\helpers\Url::to(['salereport/indexcarupdate'], true) ?>" method="post">
    <div class="row">
...
<br/>
<form action="<?= \yii\helpers\Url::to(['salereport/saveupdatecar'], true) ?>" method="post" id="form-search">
    <div id="div1">
