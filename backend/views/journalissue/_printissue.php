...
<table class="table-header" width="100%">
    ...
    <tr>
        ...
        <td style="font-size: 18px;text-align: left">
            เวลา <span><?=date('H:i:s',strtotime($model->trans_date))?></span>
        </td>
    </tr>
...
//if(file_exists('../web/uploads/slip_issue/slip.pdf')){
//    unlink('../web/uploads/slip_issue/slip.pdf');
//}

$slip_path = '';
if($branch_id == 1){
    $slip_path = '../web/uploads/company1/slip_issue/slip.pdf';
}else if($branch_id == 2){
    $slip_path = '../web/uploads/company2/slip_issue/slip.pdf';
}
...
$mpdf->SetJS('this.print();');
//$mpdf->Output('../web/uploads/slip_issue/slip.pdf', 'F');
