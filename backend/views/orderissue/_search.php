     ...
     <div class="row">
         <div class="col-lg-12">
             <div class="input-group">
                 ...
                 <?= $form->field($model, 'view_type')->widget(\kartik\select2\Select2::className(), [
                     'data' => \yii\helpers\ArrayHelper::map(\backend\helpers\IssueviewType::asArrayObject(), 'id', 'name'),
                     'options' => [
                       //  'onchange' => 'this.form.submit();'
                     ],
                     'pluginOptions' => [
