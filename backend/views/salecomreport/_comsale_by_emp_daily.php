...
<form action="<?=\yii\helpers\Url::to(['salecomreport/comdailycal'],true)?>" id="form-cal" method="post">
<div class="row">
    <div class="col-lg-3">
        <?php
...
//            }
                    ...
                    <?php
                    //  $model_order_mobile = \common\models\ComDailyCal::find()->select(['trans_dates', 'route_id', 'car_id', 'emp_1', 'emp_2', 'line_total_amt', 'total_qty', 'total_amt', 'line_com_amt', 'line_com_special_amt'])->where(['BETWEEN', 'trans_date', date('Y-m-d H:i:s', strtotime($from_date)), date('Y-m-d H:i:s', strtotime($to_date))])
                    $model_order_mobile = \common\models\ComDailyCal::find()->select(['trans_date', 'route_id', 'car_id', 'emp_1', 'emp_2', 'line_total_amt', 'total_qty', 'total_amt', 'line_com_amt', 'line_com_special_amt'])->where(['BETWEEN', 'date(trans_date)', date('Y-m-d', strtotime($from_date)), date('Y-m-d', strtotime($to_date))])
