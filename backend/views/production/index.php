...
<div class="location-index">
    ...
    <div class="row">
        ...
        <div class="col-lg-2" style="text-align: right">
            <form id="form-perpage" class="form-inline" action="<?= Url::to(['production/index'], true) ?>"
                  method="post">
    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            [
                'attribute' => 'prod_data',
                'value' => function ($data) {
                    return date('d/m/Y', strtotime($data->prod_date));
                }
            ],
            [
                'attribute' => 'plan_id',
                'value' => function ($data) {
                    return \backend\models\Plan::findNo($data->plan_id);
                }
            ],
            [
                'attribute' => 'delivery_route_id',
                'value' => function ($data) {
                    return \backend\models\Deliveryroute::findCode($data->delivery_route_id);
                }
            ],
            'status',
            //'photo',
