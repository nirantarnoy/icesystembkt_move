...
<div class="plan-form">
    ...
    <div class="row">
        ...
        <div class="col-lg-3">
            <?php $status = $model->isNewRecord? 'Open' : \backend\helpers\PlanStatus::getTypeById($model->status);?>
            <?= $form->field($model, 'status')->textInput(['readonly'=>'readonly','value'=> $status]) ?>
        </div>
    </div>
    <br />
    ...
    <div class="row">
        <div class="col-lg-12">
            <table class="table table-bordered table-tripped" id="table-list">
                <thead>
                <tr>
...
//    }
  ...
  function checkstock(e){
      ...
      var product_id = e.closest("tr").find(".line-prod-id").val();
      var issue_qty =e.val();
